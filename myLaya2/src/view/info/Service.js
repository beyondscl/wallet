...
(function (view) {
    ...
    (function (info_1) {
        ...
        var Service = /** @class */ (function (_super) {
            ...
            /* 开始滚动文本 */
            Service.prototype.startScrollText = function (e) {
            ...
            /* 停止滚动文本 */
            Service.prototype.finishScrollText = function (e) {
                Laya.stage.off(Event.MOUSE_MOVE, this, this.scrollText);
                Laya.stage.off(Event.MOUSE_UP, this, this.finishScrollText);
            };
            /* 鼠标滚动文本 */
            Service.prototype.scrollText = function (e) {
                var nowX = this.comp.text.mouseX;
                var nowY = this.comp.text.mouseY;
